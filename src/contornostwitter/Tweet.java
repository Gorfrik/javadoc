...
public class Tweet {
    ...
    */
     ...
     * Nombre de la persona que realiza el Tweet
     * @param fecha
     * Fecha en la que se creo el Tweet
     * @param contenido
     * El contenido guarda el texto del Tweet
     * @param retweets
     * Numero de retweets que tiene el Tweet
     * @param like
     * Numero de likes que tiene el Tweet
     * @param views
     * Numero de views que tiene el Tweet
     */
    ...
    /**
     * Nuevo contenido de un tweet.
     * Nuevo contenido si es menor de 280 caracteres sino guarda null.
     * @param contenido 
     */
